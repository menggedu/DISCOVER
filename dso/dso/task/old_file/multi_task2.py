...
class PDESubgridTask(PDETask):
    ...
    def process_results(self,p):
        ...
        if term_num == len(self.terms):
            print("no new added terms")
            return False # improvement
        
        if len(self.vals0)>1: 
            print(f"before removing redundants, the reward is {cur_r}")     
            ...
            _,_, cur_r = self.calculate_r(self.vals0, self.vals1, self.ut_ori)
            self.best_r = cur_r
        ...
        print(f"correlation is {self.best_r}")
        # self.best_r = cur_r  
        if (self.sample_ratio)==0:      
            diff = self.evaluate_diff(p)
            self.set_ut(diff)
        return improvement
            
    def remove_redundants(self, vals0_list, vals1_list,ut, best_r):
        ...
        for i in range(n):
            ...
            r1,w1 = self.corr                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        _eval(vals1, ut[1])
    ...
    def evaluate_diff(self, p):
        ...
        return [self.ut[0]-y_hat[0].reshape(shape), self.ut[1]-y_hat[1].reshape(shape)]

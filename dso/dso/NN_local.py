...
from dso.utils import  print_model_summary
...
def model_NN(x_train, y_train,
    ...
    print(model)
    print(print_model_summary(model))
...
if __name__ == '__main__':
    ...
    ckpt_path = f'./dso/task/pde/ckpt_local/noise{data_noise_level}_data_amount{ratio}/{dataset}/'

...
if __name__ == '__main__':
    ...
    ckpt_path = f'./dso/task/pde/ckpt_remote/noise{data_noise_level}_data_amount{ratio}/{dataset}/'
    ...
    u_true,x,t, ut,sym_true, n_input_var,test_list = load_class(dataset, 0)
    # data process
    hidden_dim= 64 if '2D' not in dataset else 256
    number_feature = 2 if '2D' not in dataset else 3
    max_epoch*=1 if '2D' not in dataset else 3
    normalize = True
